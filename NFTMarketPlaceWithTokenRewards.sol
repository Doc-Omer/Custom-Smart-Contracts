...
contract NFTMarket{
    ...
    */
    function createMarketItem(address nftContract, uint tokenId, uint price, uint royaltyFee) public payable {
    ...
    */
    ...
    function createMarketSale(address nftContract, uint itemId) public payable  {
        ...
        //On Minting token Reward
        if (isTrue[msg.sender]==true){
          IERC20(contractAddress).transfer(msg.sender,200);
        }
        else{
